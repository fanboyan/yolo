        ...
        if len(ALL_buoy)>=1:
            ...
            for i, det in enumerate(pred): # det：所有视频检测出来的信息
                ...
                if begin==1:
                    ...
                    print("正在第几个能见度的id：", visibility_id)
...
def visibility():
    ...
    if a :
        ...
        # 查询上次时间能见度
        # select_sql = "SELECT baseline_id FROM visibility_result WHERE camera_id =  %s and is_visibility=1 order by id desc limit 1" % (
        #     camera_id)
        ...
        print("所有pid", pids)
        # pids = psutil.Process()
        # # Process1=psutil.Process(pids.pid)
        # Process1=pids.children
        # print(pids)
        # print(Process1)

        # t1=psutil.Process(t.pid)
